...
- **Full-Stack Development:** Flutter, Java, JavaScript, HTML/CSS  
- **Databases:** MySQL, MongoDB, SQL Server  
- **DevOps & Tools:** Git/GitHub, Google Colab, Joblib  
...
- **job-app** — User job application portal  
- **job-backoffice** — Admin & company dashboard  
- **job-shared** — Shared Eloquent model package  

### 🔹 Liver Disease Diagnosis (AI/ML)  
ML system analyzing 1,000+ medical records, tested 6 algorithms, achieved **95%+ accuracy**.

### 🔹 Solar Energy Management System  
Enterprise platform with automated inventory tracking and role-based access control.

### 🔹 Conan Movies Hub  
Scalable movie streaming platform with admin panel and secure authentication.
...
- Build end-to-end AI products integrating Laravel + Python  
